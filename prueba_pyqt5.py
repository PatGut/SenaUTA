...
class ScreenModulos(QMainWindow):
    ...
    def initUI(self):
        ...
        self_button.setStyleSheet("font-family: Century Gothic; font-size: 40px; border: none; border-radius: 50px; background-color: #F0DE9A; color: black; ")
        ...
        button3.setStyleSheet("font-family: Century Gothic; font-size: 40px; border: none; border-radius: 50px; padding: 10px; background-color: #F0DE9A; color: black; ")
...
class ScreenABC(QMainWindow):
    ...
    def initUI(self):
        ...
        clase1_button.setStyleSheet("font-family: Century Gothic; font-size: 40px; border: none; border-radius: 50px; padding: 10px; background-color: #F0DE9A; color: black; ")
        ...
        clase2_button.setStyleSheet("font-family: Century Gothic; font-size: 40px; border: none; border-radius: 50px; padding: 10px; background-color: #F0DE9A; color: black; ")
        ...
        clase3_button.setStyleSheet("font-family: Century Gothic; font-size: 40px; border: none; border-radius: 50px; padding: 10px; background-color: #F0DE9A; color: black; ")
        ...
        clase4_button.setStyleSheet("font-family: Century Gothic; font-size: 40px; border: none; border-radius: 50px; padding: 10px; background-color: #F0DE9A; color: black; ")
        ...
        clase5_button.setStyleSheet("font-family: Century Gothic; font-size: 40px; border: none; border-radius: 50px; padding: 10px; background-color: #F0DE9A; color: black; ")
    ...
    def class1(self):
        ...
        container.setStyleSheet("text-align: top; font-family: Century Gothic;  font-weight: bold; font-size: 50px; border: none; border-radius: 50px; padding: 50px; background-color: #F4C374; color: black; ")
        ...
        letras_button.setStyleSheet("font-family: Century Gothic; font-size: 40px; border: none; border-radius: 50px; color: black; ")
        letras_button.move(int(self.width / 2) - int(500/2)+100, 300)
        boton = QPushButton('Iniciar Clase', self)
        boton.setStyleSheet("font-family: Century Gothic; font-size: 40px; border: none; border-radius: 50px; padding: 10px; background-color: #F0DE9A; color: black; ")
...
class ScreenRealizarClase(QMainWindow):
    ...
    def initUI(self):
        ...
        camara.setStyleSheet("text-align: top; font-family: Century Gothic;  font-weight: bold; font-size: 50px; border: none; border-radius: 50px; padding: 50px; background-color: #CBB187; color: black; ")
