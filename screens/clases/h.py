...
from screens.clases import g, i
colorFondo = QColor(135,206,250)

class ScreenH(QMainWindow):
    def __init__(self):
        super().__init__()
...
#Funcion para sombreado de botones
    ...
    def initUI(self):
        ...
        imagen = QLabel(self)
        pixmap = QPixmap(dirImagenes+'/letraH.png')
        ...
        args = ScreenH.get_args()  # Asegúrate de que esta función devuelva los argumentos necesarios
    ...
    def get_args():
        ...
        parser.add_argument("--min_tracking_confidence",
                            ...
                            type=int,
                            default=0.5)
        parser.add_argument("--letra", type=str, default="H")
    ...
    def back_to_previous_screen(self):
        ...
        self.previous_screen = g.ScreenG()
