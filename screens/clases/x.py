...
from screens.clases import w, y
...
#Funcion para sombreado de botones
    ...
    def initUI(self):
        ...
        args = ScreenX.get_args()  # Asegúrate de que esta función devuelva los argumentos necesarios
    ...
    def get_args():
        ...
        parser.add_argument("--min_tracking_confidence",
                            ...
                            type=int,
                            default=0.5)
        parser.add_argument("--letra", type=str, default="X")
    ...
    def back_to_previous_screen(self):
        ...
        self.previous_screen = w.ScreenW()
