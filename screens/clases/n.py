...
from screens.clases import m, ñ
colorFondo = QColor(135,206,250)

class ScreenN(QMainWindow):
    def __init__(self):
        super().__init__()
...
#Funcion para sombreado de botones
    ...
    def initUI(self):
        ...
        imagen = QLabel(self)
        pixmap = QPixmap(dirImagenes+'/letraN.png')
        ...
        args = ScreenN.get_args()  # Asegúrate de que esta función devuelva los argumentos necesarios
    ...
    def get_args():
        ...
        parser.add_argument("--min_tracking_confidence",
                            ...
                            type=int,
                            default=0.5)
        parser.add_argument("--letra", type=str, default="N")
    ...
    def back_to_previous_screen(self):
        ...
        self.previous_screen = m.ScreenM()
