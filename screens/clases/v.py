...
from screens.clases import u, w
colorFondo = QColor(135,206,250)

class ScreenV(QMainWindow):
    def __init__(self):
        super().__init__()
...
#Funcion para sombreado de botones
    ...
    def initUI(self):
        ...
        imagen = QLabel(self)
        pixmap = QPixmap(dirImagenes+'/letraV.png')
        ...
        args = ScreenV.get_args()  # Asegúrate de que esta función devuelva los argumentos necesarios
    ...
    def get_args():
        ...
        parser.add_argument("--min_tracking_confidence",
                            ...
                            type=int,
                            default=0.5)
        parser.add_argument("--letra", type=str, default="V")
    ...
    def back_to_previous_screen(self):
        ...
        self.previous_screen = u.ScreenU()
