...
from screens.clases import f, h
colorFondo = QColor(135,206,250)
class ScreenG(QMainWindow):
    def __init__(self):
        super().__init__()
...
#Funcion para sombreado de botones
    ...
    def initUI(self):
        ...
        imagen = QLabel(self)
        pixmap = QPixmap(dirImagenes+'/letraG.png')
        imagen.setPixmap(pixmap)
        imagen.setFixedSize(pixmap.width(), pixmap.height())
        # Mover la imagen a la posición central
        imagen.move(int(container.width()/2.7), int(container.height()/1.75))
        ...
        args = ScreenG.get_args()  # Asegúrate de que esta función devuelva los argumentos necesarios
    ...
    def get_args():
        ...
        parser.add_argument("--min_tracking_confidence",
                            ...
                            type=int,
                            default=0.5)
        parser.add_argument("--letra", type=str, default="G")
    ...
    def back_to_previous_screen(self):
        ...
        self.previous_screen = f.ScreenF()
